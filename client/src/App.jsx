...
export function App() {
  ...
  return (
    <div className='w-full min-h-screen bg-white dark:bg-slate-950 text-slate-950 dark:text-gray-100'>
      <header className='w-full py-4'>
        <ThemeToggle /> {/* Toggle component to switch light/dark mode */}
        <div className="max-w-5xl mx-auto my-5 px-4 text-center text-primary">
